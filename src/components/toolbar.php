                ...
                <li>
                    ...
                    <form>
                        <div class="relative rounded-l-full rounded-r-full overflow-hidden">
                            <input type="text" class="placeholder:text-xs w-full md:w-[120px] md:hover:w-[150px] md:focus:w-[220px] transition-all delay-150 ease-in-out relative z-0 bg-theme-clr-white text-on-theme-clr-white text-sm rounded-lg focus:border-theme-clr-primary block pe-10 p-2.5" placeholder="Search Services like MTN, DSTV...">
                                ...
                                <div class="">
                                    ...
                                    <div id="user-profile-dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow md:w-44 dark:bg-gray-700">
                                        <ul class="max-h-40 overflow-y-auto py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="profile-dropdown-button">
                                            ...
                                            <li>
                                                <a href="user-account.php?tab=2" class="flex gap-2 items-center px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">

                                                    My transactions
                                                </a>
                                            </li>
                                            <li>
                                                <a href="user-account.php?tab=1" class="flex gap-2 items-center px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
