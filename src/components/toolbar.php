<nav class="bg-theme-clr-primary border-gray-200 dark:bg-gray-900">
    <div class="mg-main-container flex flex-wrap items-center justify-between mx-auto p-4 lg:py-8">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul class="font-medium flex flex-col gap-2 p-0 mt-4 rounded-lg md:flex-row md:items-center md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-transparent">
                <li>
                    <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" class="py-2 text-center text-on-theme-clr-primary inline-flex items-center" type="button">
