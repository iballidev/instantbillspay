...
<form>
    <div class="grid grid-cols-12 gap-4 mb-4">
        <div class="col-span-12">
            <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white required">Enter Email Address</label>
...
<div id="alert-3" class="flex items-center p-4 mb-4 text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400" role="alert">
    ...
    <div class="ms-3 text-sm font-medium">
        <p>You will recieve a Reset Password Email, if you have an account with us.<br/>Please Check your Mail Inbox.</p>
    </div>
