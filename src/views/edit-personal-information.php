...
<h1 class="text-xl font-bold mb-4">Edit Personal Info</h1>
...
<form>
    <div class="grid grid-cols-12 gap-4 mb-4">
        ...
        <div class="col-span-12">
            <label for="dob" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white required">Date of Birth</label>
