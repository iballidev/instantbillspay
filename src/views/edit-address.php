<h1 class="text-xl font-bold mb-4">Edit Addres</h1>
...
<form>
    <div class="grid grid-cols-12 gap-4 mb-4">
        <div class="col-span-12">
            <label for="address_line" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white required">Address Line</label>
            <input type="text" id="address_line" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
        </div>
        <div class="col-span-12 md:col-span-6">
            <label for="state" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white required">State</label>
        ...
        <div class="col-span-6 md:col-span-2">
            <label for="postal_code" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white required">Postal Code</label>
            <input type="text" id="postal_code" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
        </div>

        <div class="col-span-6 md:col-span-4">
            <label for="country" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white required">Country</label>
